...
import './App.css';
import { getCustomers, createCustomer, removeCustomer, Customer as ApiCustomer } from './api/customers';
import './App.css';
...
function App(): React.ReactElement {
  ...
  const addCustomer = async () => {
    ...
    try {
      const res = await createCustomer({ name, phone, city, gold_type: goldType });
  ...
  const getMostInterestedGoldType = (): string => {
    ...
    const mostInterested = Object.keys(counts).filter(
    ...
    <div className="main-container">
      ...
      <div className="sidebar">
        ...
        <ul>
          ...
          <li className="disabled">Orders (Coming Soon)</li>

          <li className="disabled">Sales (Coming Soon)</li>
      ...
      <div className="content">
        ...
        <div className="dashboard-cards">
          ...
          <div className="card">
            ...
            <p>
              ...
              {customers.reduce((total, customer) => total + (customer.visit_count || 0), 0)}
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <input type="text" placeholder="Gold Type" value={goldType} onChange={(e) => setGoldType(e.target.value)} />
